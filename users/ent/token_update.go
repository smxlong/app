...
func (tu *TokenUpdate) SetNillableType(t *token.Type) *TokenUpdate {
	if t != nil {
		tu.SetType(*t)
	}
	return tu
...
func (tu *TokenUpdate) SetNillableUserID(id *string) *TokenUpdate {
	if id != nil {
		tu = tu.SetUserID(*id)
	}
	return tu
...
// SetUserID sets the "user" edge to the User entity by ID.
func (tuo *TokenUpdateOne) SetUserID(id string) *TokenUpdateOne {
	tuo.mutation.SetUserID(id)
	return tuo
}

// SetNillableUserID sets the "user" edge to the User entity by ID if the given value is not nil.
func (tuo *TokenUpdateOne) SetNillableUserID(id *string) *TokenUpdateOne {
	if id != nil {
